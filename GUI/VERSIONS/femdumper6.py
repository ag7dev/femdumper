...
from PyQt6.QtWidgets import (
    ...
    QTabBar, QListWidget, QListWidgetItem, QInputDialog
)
...
class FemDumperApp(QMainWindow):
    ...
    def create_settings_tab(self):
        ...
        self.anim_slider.setValue(self.settings["anim_intensity"])
        ...
        self.glow_toggle.setChecked(self.settings["glow_effects"])
        ...
        self.add_keyword_btn = ShinyButton("Add Keyword")
        self.add_keyword_btn.clicked.connect(self.add_keyword)
        
        self.edit_keyword_btn = ShinyButton("Edit Keyword")
        self.edit_keyword_btn.clicked.connect(self.edit_keyword)
        
        self.remove_keyword_btn = ShinyButton("Remove Keyword")
        ...
        self.add_folder_btn = ShinyButton("Add Folder")
        self.add_folder_btn.clicked.connect(self.add_folder)
        
        self.edit_folder_btn = ShinyButton("Edit Folder")
        self.edit_folder_btn.clicked.connect(self.edit_folder)
        
        self.remove_folder_btn = ShinyButton("Remove Folder")
        ...
        self.save_settings_btn = ShinyButton("Save All Settings")
    ...
    def save_all_settings(self):
        ...
        self.settings["anim_intensity"] = self.anim_slider.value()
        self.settings["glow_effects"] = self.glow_toggle.isChecked()
        ...
        if save_settings(self.settings):
            ...
            if self.current_theme != self.settings["theme"]:
    ...
    def custom_colors(self):
        ...
        if color.isValid():
            ...
            # Determine theme type based on lightness
            lightness = color.lightness()
            theme_type = "light" if lightness > 127 else "dark"
            ...
            THEMES[theme_name] = {
                ...
                "text": "#ffffff" if theme_type == "dark" else "#000000",
